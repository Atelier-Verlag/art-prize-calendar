...
export const mockArtPrizes: ArtPrize[] = [
  {
    ...
    deadline: '2025-01-15',
    prizeAmount: 15000,
    benefitDetails: '1. Preis: 15.000€, 2. Preis: 5.000€',
    region: 'Bayern',
    country: 'Deutschland',
    ageMin: 18,
    ageMax: 40,
  ...
  },
  {
    ...
    deadline: '2025-02-28',
    prizeAmount: 25000,
    benefitDetails: 'Gewinn: 25.000€ + Einzelausstellung',
  ...
  },
  {
    ...
    deadline: '2025-01-20',
    prizeAmount: null,
    benefitDetails: '1.500€ / Monat (3 Monate) + Studio',
    region: 'International',
    country: 'Deutschland',
    ageMin: null,
    ageMax: 35,
  ...
  },
  {
    ...
    deadline: '2025-03-15',
    prizeAmount: 20000,
    benefitDetails: 'Gewinn: 20.000 CHF + Katalog',
    region: 'Europa',
    country: 'Schweiz',
    ageMin: 21,
    ageMax: 45,
  ...
  },
  {
    ...
    deadline: '2025-01-10',
    prizeAmount: 8000,
    benefitDetails: 'Projektförderung: 8.000€',
    region: 'International',
    country: 'Deutschland',
    ageMin: null,
    ageMax: null,
  ...
  },
  {
    ...
    deadline: '2025-04-01',
    prizeAmount: 12000,
    benefitDetails: '1. Preis: 12.000€, 2. Preis: 6.000€',
    region: 'Deutschland',
    country: 'Deutschland',
    ageMin: 25,
    ageMax: 50,
  ...
  },
  {
    ...
    deadline: '2025-02-15',
    prizeAmount: null,
    benefitDetails: '1.200€ / Monat (6-12 Mon.) + Studio + Unterkunft',
    region: 'International',
    country: 'Deutschland',
    ageMin: null,
    ageMax: 35,
  ...
  },
  {
    ...
    deadline: '2025-05-01',
    prizeAmount: 30000,
    benefitDetails: 'Gewinn: 30.000€ + 12 Mon. Villa Medici',
    region: 'International',
    country: 'Frankreich',
    ageMin: null,
    ageMax: 45,
  ...
  },
  {
    ...
    deadline: '2025-03-30',
    prizeAmount: 50000,
    benefitDetails: 'Gewinn: 50.000 USD + Ausstellung',
    region: 'International',
    country: 'Südkorea',
    ageMin: null,
    ageMax: null,
  ...
  {
    id: '11',
    name: 'Biennale de la Céramique Carouge',
    organizer: 'Ville de Carouge',
    category: 'Wettbewerb',
    deadline: '2025-04-15',
    prizeAmount: 10000,
    benefitDetails: 'Gewinn: 10.000 CHF',
    region: 'International',
    country: 'Schweiz',
    ageMin: null,
    ageMax: null,
    fee: null,
    description: 'Internationaler Keramikwettbewerb in der Schweiz.',
  ...
  },
  {
    ...
    deadline: '2025-02-20',
    prizeAmount: null,
    benefitDetails: 'Katalog + Reisekosten + Vernissage',
    region: 'DACH',
    country: 'Deutschland',
    ageMin: 18,
    ageMax: 35,
    fee: null,
    description: 'Gruppenausstellung für junge Künstler*innen aus dem DACH-Raum.',
